...
- d'un fichier csv déjà existant. (vous pouvez partir de [ce fichier exemple](https://github.com/etalab/schema-flotte-publique-vehicule/raw/v0.1.2/exemple-valide.csv) - pour le télécharger : Fichier > Enregistrer sous).
- d'un formulaire
- d'un tableur
